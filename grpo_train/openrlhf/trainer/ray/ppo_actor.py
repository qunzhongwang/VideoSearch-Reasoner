...
class ActorPPOTrainer(PPOTrainer):
    def __init__(
        ...
        **kwargs,
        ...
        self.gt_path = ["/m2v_intern/wangqunzhong/research/repository/Pixel-Reasoner/curiosity_driven_rl/data/videogen-grpo-new.parquet", "/m2v_intern/wangqunzhong/research/repository/Pixel-Reasoner/curiosity_driven_rl/data/grpo_new_kwaihuman.parquet", "/m2v_intern/wangqunzhong/research/repository/Pixel-Reasoner/curiosity_driven_rl/data/videogen-distill-new-eval.parquet", "/m2v_intern/wangqunzhong/research/repository/Pixel-Reasoner/curiosity_driven_rl/data/grpo_new_eval_kwaihuman.parquet"]
...
class ActorModelRayActor(BasePPORole):
    def init_model_from_pretrained(self, strategy: DeepspeedStrategy, pretrain):
        ...
        if args.reinit_wanb == "no":
            ...
            self.consumed_samples =  args.resume_step * args.rollout_batch_size
        
        # print(f"!!!![verbose]{args.ckpt_path}")
        ...
        # if f == 0:
        #     self.consumed_samples = 23*64
        #     print(f"!!!![verbose] not ok")
        #     print(f"{self.consumed_samples}")
    def prepare_datasets(self):
        strategy = self.strategy
        args = self.strategy.args

        # prepare datasets
        args.prompt_data = "/m2v_intern/wangqunzhong/research/repository/Pixel-Reasoner/curiosity_driven_rl/data/videogen-grpo-new.parquet,/m2v_intern/wangqunzhong/research/repository/Pixel-Reasoner/curiosity_driven_rl/data/grpo_new_kwaihuman.parquet"
        args.prompt_data_probs = "0.5,0.5"
        ...
        eval_dp = "/m2v_intern/wangqunzhong/research/repository/Pixel-Reasoner/curiosity_driven_rl/data/videogen-distill-new-eval.parquet,/m2v_intern/wangqunzhong/research/repository/Pixel-Reasoner/curiosity_driven_rl/data/grpo_new_eval_kwaihuman.parquet"
        self.eval_data = None
        if eval_dp: 
