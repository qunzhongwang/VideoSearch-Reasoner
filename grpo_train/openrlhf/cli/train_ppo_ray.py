...
def train(args):
    ...
    actor_model = PPORayActorGroup(
        ...
        ActorModelRayActor,
        pg=pg,
        num_gpus_per_actor=0.675 if pg else 1,
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--reinit_wanb", type=str, default="no")
    parser.add_argument("--collect_method", type=str, default="last")
    parser.add_argument("--max_chain_length", type=int, default=3)
    parser.add_argument("--micro_rollout_eval_batch_size", type=int, default=1)
    parser.add_argument("--old_rollout_batch_size", type=int, default=16)
